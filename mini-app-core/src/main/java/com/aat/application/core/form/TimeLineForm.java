...
public abstract class TimeLineForm extends VerticalLayout {
    ...
    public TimeLineForm(TimelineService timelineService, String groupName) {
...
//        add(timeline, formLayout);
    ...
    private List<Item> getItems() {
        ...
        if (filterText != null) itemData = timelineService.findAllByFilter(filterText.getValue());
