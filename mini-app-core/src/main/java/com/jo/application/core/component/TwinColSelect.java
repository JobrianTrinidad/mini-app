package com.jo.application.core.component;
...
public class TwinColSelect extends Div {
    ...
    private org.vaadin.tatu.TwinColSelect<String> twinColSelect;
    ...
    private void initial() {
        ...
        twinColSelect = new org.vaadin.tatu.TwinColSelect<>();
    ...
    public void select(Iterable<String> items) {
        if (items != null) {
            ...
            twinColSelect.clearTicks(org.vaadin.tatu.TwinColSelect.ColType.RIGHT);
    ...
    private void addEventInItems(org.vaadin.tatu.TwinColSelect<String> twinColSelect) {
        List<Component> liveParent = GlobalData.findComponentsWithAttribute(twinColSelect, "aria-live");
    ...
    private void updateTwinColSelectOrder() {
        ...
        org.vaadin.tatu.TwinColSelect<String> newTwinColSelect = new org.vaadin.tatu.TwinColSelect<>();
