...
@Route(value = "service-type-task/:subcategory?/:filter?", layout = MainLayout.class)
public class ServiceTypeTaskView extends StandardFormView implements HasUrlParameter<String> {

    GridViewParameter gridViewParameter;

    public ServiceTypeTaskView(BaseEntityRepository repository, TableInfoService tableInfoService) {
        super(repository, tableInfoService);
        gridViewParameter = new GridViewParameter(ZJTServiceTypeTask.class, "");
